...
\leantexconfig{hausdorff-01}{infoview=lines:5}
\begin{minted}[label=hausdorff-01]{lean}
...
\leantexconfig{hausdorff-02}{infoview=lines:5}
\begin{minted}[label=hausdorff-02]{lean}
...
\leantexconfig{hausdorff-03}{infoview=lines:5}
\begin{minted}[label=hausdorff-03]{lean}
...
\leantexconfig{hausdorff-04}{infoview=lines:5}
\begin{minted}[label=hausdorff-04]{lean}
...
\leantexconfig{hausdorff-05}{infoview=lines:5}
\begin{minted}[label=hausdorff-05]{lean}
...
\leantexconfig{hausdorff-06}{infoview=lines:5}
\begin{minted}[label=hausdorff-06]{lean}
...
\leantexconfig{hausdorff-07}{infoview=lines:5}
\begin{minted}[label=hausdorff-07]{lean}
  theorem prodhdishd (X : Type u) (Y : Type v) [TopologicalSpace X] [TopologicalSpace Y] [hhausx : TopologyIsHausdorff X] [hhausy : TopologyIsHausdorff Y] : TopologyIsHausdorff (X × Y) := by
...
\leantexoutput{hausdorff-07}

Here is the singleton by monotonicity of closure. 
\leantexconfig{hausdorff-08}{infoview=lines:5}
\begin{minted}[label=hausdorff-08]{lean}
